...
public class DataHasilAG {
    ...
    public void set_probabilitasCrossover(double probabilitas_crossover){
        this.probabilitas_crossover = probabilitas_crossover;
    }
    ...
    public double get_probabilitasCrossover(){
        return probabilitas_crossover;
    }
